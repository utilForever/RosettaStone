...
//    cards.emplace("EX1_154b", CardDef(power));
...
//    cards.emplace("EX1_155a", CardDef(power));
...
//    cards.emplace("EX1_155b", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 2));
//    cards.emplace("EX1_166a", CardDef(power));
...
//    cards.emplace("EX1_166b", CardDef(power));
...
//    cards.emplace("EX1_160a", CardDef(power));
...
//    cards.emplace("NEW1_007b", CardDef(power));
...
//    cards.emplace("NEW1_008b", CardDef(power));
...
//    cards.emplace("EX1_537", CardDef(power));
...
//    cards.emplace("EX1_538", CardDef(power));
...
//    cards.emplace("EX1_549", CardDef(power));
...
//    cards.emplace("EX1_617", CardDef(power));
...
//    cards.emplace("EX1_179", CardDef(power));
...
//    cards.emplace("EX1_275", CardDef(power));
...
//    cards.emplace("EX1_279", CardDef(power));
...
//    power.AddPowerTask(std::make_shared<DrawTask>(3));
//    cards.emplace("EX1_354", CardDef(power));
...
//    cards.emplace("EX1_355", CardDef(power));
...
//    cards.emplace("EX1_362", CardDef(power));
...
//    cards.emplace("EX1_363", CardDef(power));
...
//    power.AddPowerTask(
//        std::make_shared<DamageNumberTask>(EntityType::TARGET, true));
//    cards.emplace("EX1_365", CardDef(power));
...
//    cards.emplace("EX1_382", CardDef(power));
...
//    cards.emplace("CS1_129", CardDef(power));
...
//    cards.emplace("EX1_091", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<SilenceTask>(EntityType::TARGET));
//    cards.emplace("EX1_332", CardDef(power));
...
//    cards.emplace("EX1_334", CardDef(power));
...
//                                                      SummonSide::SPELL) }));
//    cards.emplace("EX1_345", CardDef(power));
...
//    cards.emplace("EX1_623", CardDef(power));
...
//    cards.emplace("EX1_624", CardDef(power));
...
//    cards.emplace("CS2_073", CardDef(power));
...
//    cards.emplace("CS2_233", CardDef(power));
...
//    power.AddComboTask(
//        std::make_shared<DamageTask>(EntityType::TARGET, 4, true));
//    cards.emplace("EX1_124", CardDef(power));
...
//    cards.emplace("EX1_126", CardDef(power));
...
//    cards.emplace("EX1_133", CardDef(power));
...
//    power.ClearData();
//    power.AddComboTask(std::make_shared<DamageTask>(EntityType::TARGET, 2));
//    cards.emplace("EX1_134", CardDef(power));
...
//    cards.emplace("EX1_144", CardDef(power));
...
//    cards.emplace("NEW1_005", CardDef(power));
...
//    cards.emplace("NEW1_014", CardDef(power));
...
//    cards.emplace("CS2_038", CardDef(power));
...
//    power.AddPowerTask(
//        std::make_shared<DamageTask>(EntityType::TARGET, 3, true));
//    cards.emplace("EX1_238", CardDef(power));
...
//    power.AddPowerTask(
//        std::make_shared<DamageTask>(EntityType::TARGET, 5, true));
//    cards.emplace("EX1_241", CardDef(power));
...
//    power.AddPowerTask(
//        std::make_shared<DamageTask>(EntityType::TARGET, 1, true));
//    cards.emplace("EX1_245", CardDef(power));
...
//    cards.emplace("EX1_248", CardDef(power));
...
//    power.AddPowerTask(
//        std::make_shared<DamageTask>(EntityType::STACK, 2, true));
//    cards.emplace("EX1_251", CardDef(power));
...
//    cards.emplace("EX1_303", CardDef(power));
...
//    cards.emplace("EX1_309", CardDef(power));
...
//    cards.emplace("EX1_320", CardDef(power));
...
//    cards.emplace("EX1_596", CardDef(power));
...
//    cards.emplace("CS2_104", CardDef(power));
...
//    power.AddPowerTask(std::make_shared<FlagTask>(
//        true, TaskList{ std::make_shared<DrawTask>(1) }));
//    cards.emplace("EX1_391", CardDef(power));
...
//    cards.emplace("EX1_392", CardDef(power));
...
//    power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::STACK));
//    cards.emplace("EX1_407", CardDef(power));
...
//    cards.emplace("EX1_408", CardDef(power));
...
//    power.AddPowerTask(
//        std::make_shared<DamageNumberTask>(EntityType::TARGET, true));
//    cards.emplace("EX1_410", CardDef(power));
...
//    cards.emplace("EX1_603", CardDef(power));
...
//    cards.emplace("EX1_607", CardDef(power));
...
//    cards.emplace("CS2_117", CardDef(power));
...
//    cards.emplace("CS2_188", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<SilenceTask>(EntityType::TARGET));
//    cards.emplace("CS2_203", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::TARGET));
//    cards.emplace("EX1_002", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::TARGET));
//    cards.emplace("EX1_005", CardDef(power));
...
//    cards.emplace("EX1_046", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<SilenceTask>(EntityType::TARGET));
//    cards.emplace("EX1_048", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<ReturnHandTask>(EntityType::TARGET));
//    cards.emplace("EX1_049", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<ReturnHandTask>(EntityType::TARGET));
//    cards.emplace("EX1_057", CardDef(power));
...
//    cards.emplace("EX1_059", CardDef(power));
...
//                                                        GameTag::FROZEN, 1));
//    cards.emplace("EX1_283", CardDef(power));
...
//    cards.emplace("EX1_561", CardDef(power));
...
//    cards.emplace("EX1_564", CardDef(power));
...
//                                      EntityType::HAND) };
//    cards.emplace("EX1_572", CardDef(power));
//    entourages.emplace(
...
//    cards.emplace("NEW1_017", CardDef(power));
...
//    cards.emplace("EX1_014t", CardDef(power));
...
//    power.ClearData();
//    power.AddPowerTask(std::make_shared<ReturnHandTask>(EntityType::TARGET));
//    cards.emplace("DREAM_04", CardDef(power));
...
//    cards.emplace("DREAM_05", CardDef(power));
