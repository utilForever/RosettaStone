...
{
    auto randCards = RandomCardTask::GetCardList(m_source, m_cardType,
                                                 m_cardClass, m_race, m_rarity);
...
{
    return std::make_unique<ChangeEntityTask>(m_entityType, m_cardType,
                                              m_cardClass, m_race, m_rarity,
                                              m_removeEnchantments);
}
}  // namespace RosettaStone::SimpleTasks
