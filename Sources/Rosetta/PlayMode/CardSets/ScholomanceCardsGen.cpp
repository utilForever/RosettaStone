...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<RandomMinionTask>(TagValues{
//        { GameTag::COST, 3, RelaSign::EQ },
//        { GameTag::CARDRACE, static_cast<int>(Race::BEAST), RelaSign::EQ } }));
...
//    cardDef.power.AddSpellburstTask(std::make_shared<AddStackToTask>(EntityType::HAND));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DiscoverTask>(DiscoverType::DEMON));
//    cardDef.power.AddPowerTask(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTopdeckTask(std::make_shared<HealTask>(EntityType::HERO, 2));
...
//    cardDef.power.AddComboTask(std::make_shared<FreezeTask>(EntityType::TARGET));
//    cardDef.power.AddComboTask(
//        std::make_shared<DamageTask>(EntityType::TARGET, 3, true));
//    cards.emplace(
//        "SCH_509",
...
//    cardDef.power.AddComboTask(std::make_shared<DestroyTask>(EntityType::TARGET));
//    cards.emplace(
//        "SCH_521",
//        CardDef(power,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<Aura>(AuraType::HERO_POWER,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<Aura>(AuraType::ENEMY_HAND, "SCH_713e2"));
//    {
//        const auto aura = dynamic_cast<Aura*>(power.GetAura());
//        aura->condition =
//            std::make_shared<SelfCondition>(SelfCondition::IsSpell());
