...
//    cards.emplace("ULD_140p", CardDef(power));
//
//    // ------------------------------------ HERO_POWER - HUNTER
...
//    cardDef.power.AddPowerTask(std::make_shared<AttackTask>(EntityType::STACK,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::TARGET, 12));
//    cards.emplace(
//        "ULD_135b",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<SummonCopyTask>(EntityType::SOURCE));
//    cards.emplace(
//        "ULD_292b",
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<IncludeTask>(EntityType::ENEMY_HAND));
...
//    cardDef.power.AddPowerTask(std::make_shared<AttackTask>(EntityType::SOURCE,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::AFTER_ATTACKED));
//    power.GetTrigger()->triggerSource = TriggerSource::HERO;
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 6));
//    cards.emplace(
//        "ULD_293",
//        CardDef(
//            power,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<IncludeTask>(EntityType::DECK));
//    cardDef.power.AddDeathrattleTask(std::make_shared<FilterStackTask>(SelfCondList{
...
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 7));
//    cardDef.power.AddPowerTask(std::make_shared<SummonStackTask>(true));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Effects::SetAttackHealth(2)));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<IncludeTask>(EntityType::GRAVEYARD));
//    cardDef.power.AddPowerTask(std::make_shared<FilterStackTask>(SelfCondList{
//        std::make_shared<SelfCondition>(SelfCondition::IsDead()) }));
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 1));
//    cardDef.power.AddPowerTask(
//        std::make_shared<CopyTask>(EntityType::STACK, ZoneType::PLAY, 1, true));
//    cardDef.power.AddPowerTask(std::make_shared<SetGameTagTask>(EntityType::STACK,
//                                                        GameTag::REBORN, 1));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::TARGET, true));
//    cardDef.power.AddPowerTask(
...
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::FRIENDS, 1));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<SilenceTask>(EntityType::ALL_MINIONS));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Enchants::SetHealthScriptTag));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_unique<Enchant>(Effects::AttackHealthN(3)));
...
//        std::make_shared<SelfCondition>(SelfCondition::IsMinion()),
//        std::make_shared<SelfCondition>(SelfCondition::IsRace(Race::TOTEM)) }));
//    cardDef.power.AddPowerTask(std::make_shared<SummonCopyTask>(EntityType::STACK));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DiscoverTask>(DiscoverType::LACKEY));
...
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::TARGET));
//    cardDef.power.AddPowerTask(std::make_shared<DamageNumberTask>(EntityType::HERO));
//    cards.emplace(
//        "ULD_165",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 },
//                                 { PlayReq::REQ_MINION_TARGET, 0 } }));
...
//        }));
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::MINIONS));
...
//    cards.emplace("ULD_140e", CardDef(power));
//
//    // --------------------------------------- MINION - WARLOCK
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<IncludeTask>(EntityType::HAND));
//    cardDef.power.AddDeathrattleTask(std::make_shared<FilterStackTask>(SelfCondList{
//        std::make_shared<SelfCondition>(SelfCondition::IsMinion()) }));
//    cardDef.power.AddDeathrattleTask(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<EnrageEffect>(AuraType::SELF, "ULD_185e"));
...
//    cardDef.power.AddPowerTask(std::make_shared<GetGameTagTask>(EntityType::SOURCE,
//                                                        GameTag::DAMAGE, 0, 1));
//    cardDef.power.AddPowerTask(
//        std::make_shared<MathNumberIndexTask>(0, 1, MathOperation::SUB));
...
//    cardDef.power.AddPowerTask(std::make_shared<HealFullTask>(EntityType::STACK));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<HealTask>(EntityType::HERO, 3));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<Aura>(AuraType::ENEMY_HAND,
...
//    cards.emplace("ULD_229", CardDef(power));
//
//    // --------------------------------------- MINION - NEUTRAL
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::SOURCE, 3));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::PLAY_MINION));
//    power.GetTrigger()->triggerSource = TriggerSource::FRIENDLY;
//    power.GetTrigger()->tasks = {
//        std::make_shared<IncludeTask>(EntityType::HAND),
//        std::make_shared<FilterStackTask>(SelfCondList{
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::AFTER_PLAY_CARD));
//    power.GetTrigger()->conditions = SelfCondList{
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_unique<Enchant>(Enchants::AddHealthScriptTag));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Effects::AttackHealthN(2)));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Effects::AttackHealthN(1)));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Effects::SetAttackHealth(1)));
