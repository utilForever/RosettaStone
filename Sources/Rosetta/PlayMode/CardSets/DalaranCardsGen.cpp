...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealFullTask>(EntityType::HEROES));
...
//    cardDef.power.AddPowerTask(std::make_shared<SummonStackTask>(true));
//    cardDef.power.AddPowerTask(std::make_shared<AttackTask>(EntityType::STACK_NUM0,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<TransformCopyTask>(false, true));
//    cardDef.power.AddPowerTask(
...
//    cardDef.power.AddPowerTask(std::make_shared<SummonCopyTask>(EntityType::TARGET));
//    cards.emplace(
//        "DAL_065",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 },
//                                 { PlayReq::REQ_MINION_TARGET, 0 },
...
//                                                        GameTag::ATK, 0, 1));
//    cardDef.power.AddPowerTask(std::make_shared<NumberConditionTask>(RelaSign::GEQ));
//    cardDef.power.AddPowerTask(std::make_shared<FlagTask>(
//        true, TaskList{ std::make_shared<DestroyTask>(EntityType::TARGET) }));
//    cardDef.power.AddPowerTask(std::make_shared<IncludeTask>(EntityType::SOURCE));
...
//    cardDef.power.AddPowerTask(std::make_shared<FilterStackTask>(SelfCondList{
//        std::make_shared<SelfCondition>(SelfCondition::IsDead()) }));
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 3));
//    cardDef.power.AddPowerTask(
//        std::make_shared<CopyTask>(EntityType::STACK, ZoneType::PLAY));
//    cards.emplace(
//        "DAL_724",
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::SHUFFLE_INTO_DECK));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<ReturnHandTask>(EntityType::MINIONS));
...
//        std::make_shared<SelfCondition>(SelfCondition::IsMinion()) }));
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 1));
//    cardDef.power.AddPowerTask(std::make_shared<ChangeEntityTask>(EntityType::SOURCE,
//                                                          EntityType::STACK));
//    cardDef.power.AddPowerTask(
...
//    cardDef.power.AddPowerTask(std::make_shared<GetGameTagTask>(
//        EntityType::SOURCE, GameTag::TAG_SCRIPT_DATA_NUM_1));
//    cardDef.power.AddPowerTask(std::make_shared<SummonNumberTask>("DAL_751t", false));
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::TURN_END));
//    power.GetTrigger()->triggerActivation = TriggerActivation::HAND;
//    power.GetTrigger()->tasks = {
//        std::make_shared<GetGameTagTask>(EntityType::SOURCE,
...
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::STACK, true));
//    cardDef.power.AddPowerTask(std::make_shared<EnqueueNumberTask>(TaskList{
//        std::make_shared<IncludeTask>(EntityType::DECK),
//        std::make_shared<FilterStackTask>(SelfCondList{
//            std::make_shared<SelfCondition>(SelfCondition::IsMinion()) }),
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTopdeckTask(std::make_shared<HealTask>(EntityType::HERO, 4));
...
//    cardDef.power.AddPowerTask(std::make_shared<IncludeTask>(EntityType::HAND));
//    cardDef.power.AddPowerTask(std::make_shared<CountTask>(EntityType::STACK));
//    cardDef.power.AddPowerTask(std::make_shared<MoveToDeckTask>(EntityType::STACK));
...
//    cardDef.power.AddPowerTask(std::make_shared<CountTask>(EntityType::STACK));
//    cardDef.power.AddPowerTask(std::make_shared<NumberConditionTask>(4, RelaSign::GEQ));
//    cardDef.power.AddPowerTask(std::make_shared<FlagTask>(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::DEAL_DAMAGE));
...
//        std::make_shared<SelfCondition>(SelfCondition::IsSpell()) }));
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 1));
//    cardDef.power.AddPowerTask(std::make_shared<PlayTask>(PlayType::SPELL, true));
...
//    cardDef.power.AddPowerTask(std::make_shared<SilenceTask>(EntityType::STACK));
...
//    cardDef.power.AddPowerTask(std::make_shared<CountTask>(ZoneType::PLAY, true, true));
//    cardDef.power.AddPowerTask(std::make_shared<SummonNumberTask>(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_unique<Enchant>(Enchants::AddAttackScriptTag));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_unique<Enchant>(Enchants::SetHealthScriptTag));
