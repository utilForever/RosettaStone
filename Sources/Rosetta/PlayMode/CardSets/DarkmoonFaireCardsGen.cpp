...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DiscoverTask>(DiscoverType::SECRET));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddSpellburstTask(std::make_shared<IncludeTask>(EntityType::ENEMIES));
//    cardDef.power.AddSpellburstTask(std::make_shared<FilterStackTask>(SelfCondList{
//        std::make_shared<SelfCondition>(SelfCondition::IsFrozen()) }));
//    cardDef.power.AddSpellburstTask(std::make_shared<DamageTask>(EntityType::STACK, 3));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 12));
//    cards.emplace(
//        "DMF_101t",
...
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::STACK, 2));
...
//    cardDef.power.AddPowerTask(std::make_shared<ManaCrystalTask>(-1, false, false));
...
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::HERO, 3, true));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(ComplexTask::GiveBuffToRandomMinionInHand("DMF_531e"));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddOutcastTask(std::make_shared<DamageTask>(EntityType::ENEMIES, 1));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::HERO, 4));
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::ENEMY_HERO, 4));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(ComplexTask::GiveBuffToRandomMinionInHand("DMF_189e"));
