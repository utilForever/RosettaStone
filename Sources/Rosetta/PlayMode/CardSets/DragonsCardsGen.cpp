...
//    cardDef.power.AddPowerTask(
//        std::make_shared<IncludeTask>(EntityType::ENEMY_MINIONS));
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 4));
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::STACK));
//    cardDef.power.AddPowerTask(std::make_shared<WeaponTask>("DRG_238ht"));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DiscoverTask>(DiscoverType::DRAGON));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Effects::SetBaseHealth(1)));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<ManaCrystalTask>(10, false, false));
//    cardDef.power.AddPowerTask(std::make_shared<ManaCrystalTask>(10, false, true));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DestroyAllTask>(EntityType::TARGET));
//    cards.emplace(
//        "DRG_037",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_IF_AVAILABLE, 0 },
//                                 { PlayReq::REQ_MINION_TARGET, 0 } }));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::ALL, 1, true));
...
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 1));
//    cardDef.power.AddPowerTask(std::make_shared<AttackTask>(EntityType::TARGET,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<CountTask>(EntityType::ENEMY_HAND));
//    cardDef.power.AddPowerTask(std::make_shared<AddEnchantmentTask>(
...
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::STACK, 3));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<SetGameTagTask>(EntityType::ENEMY_HERO,
//                                                        GameTag::ARMOR, 0));
...
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::STACK, 4));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Enchants::AddAttackScriptTag));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<SummonCapturedMinionTask>());
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<Aura>(AuraType::ENEMY_HERO_POWER,
