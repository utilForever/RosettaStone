...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DrawSpellTask>(SpellSchool::HOLY, 1));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(ComplexTask::GiveBuffToRandomMinionInField("BAR_880e"));
//    cardDef.power.AddTrigger(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::MINIONS, 2));
//    cardDef.power.AddPowerTask(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::MINIONS, 3));
//    cardDef.power.AddPowerTask(
//        std::make_shared<AddEnchantmentTask>("BAR_880e", EntityType::STACK));
//    cards.emplace(
//        "BAR_880t2",
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<CountTask>(EntityType::HAND_SPELL));
...
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::ENEMY_HERO, 5));
...
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::STACK, 2));
//    cardDef.power.AddPowerTask(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<Aura>(AuraType::ENEMY_HAND, "WC_040e"));
//    {
//        const auto aura = dynamic_cast<Aura*>(power.GetAura());
//        aura->condition =
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddFrenzyTask(std::make_shared<IncludeTask>(EntityType::ENEMIES));
//    cardDef.power.AddFrenzyTask(std::make_shared<RandomTask>(EntityType::STACK, 1));
//    cardDef.power.AddFrenzyTask(
...
//    cardDef.power.AddFrenzyTask(std::make_shared<AddStackToTask>(EntityType::HAND));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<HealTask>(EntityType::HERO, 4));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<DamageTask>(EntityType::HERO, 5));
...
//    cardDef.power.AddPowerTask(std::make_shared<RandomMinionNumberTask>(GameTag::COST));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::SOURCE, 6));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::AFTER_DRAW_CARD));
//    power.GetTrigger()->triggerSource = TriggerSource::ENEMY;
//    power.GetTrigger()->conditions = SelfCondList{
...
//    cardDef.power.AddPowerTask(std::make_shared<SummonNumberTask>("BAR_077t", false,
//                                                          SummonSide::RIGHT));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_shared<Enchant>(Effects::DurabilityN(1)));
