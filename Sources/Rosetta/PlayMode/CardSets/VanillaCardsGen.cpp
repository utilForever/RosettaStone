...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<FuncNumberTask>([](Playable* playable) {
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<AddEnchantmentTask>("AT_132_DRUIDe",
//                                                            EntityType::HERO));
//    cardDef.power.AddPowerTask(std::make_shared<ArmorTask>(2));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::TARGET, 2));
//    cards.emplace(
//        "VAN_HERO_09bp",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::TARGET, 4));
//    cards.emplace(
//        "VAN_HERO_09bp2",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<AddEnchantmentTask>("VAN_HERO_10bpe",
//                                                            EntityType::HERO));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<AddEnchantmentTask>("VAN_HERO_10pe2",
//                                                            EntityType::HERO));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::TARGET, 8));
//    cards.emplace(
//        "VAN_CS2_007",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::TARGET));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 5));
//    cardDef.power.AddPowerTask(std::make_shared<DrawTask>(1));
//    cards.emplace(
//        "VAN_EX1_173",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 2));
//    cards.emplace(
//        "VAN_EX1_166a",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<SilenceTask>(EntityType::TARGET));
//    cards.emplace(
//        "VAN_EX1_166b",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 },
//                                 { PlayReq::REQ_MINION_TARGET, 0 } }));
...
//    cards.emplace("VAN_NEW1_007a", CardDef(power));
//
//    // ------------------------------------------ SPELL - DRUID
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::TARGET, 5));
//    cards.emplace(
//        "VAN_NEW1_008b",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
//}
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::SECRET_REVEALED));
//    power.GetTrigger()->triggerSource = TriggerSource::FRIENDLY;
//    power.GetTrigger()->tasks = { std::make_shared<AddEnchantmentTask>(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<CountTask>(EntityType::ENEMY_MINIONS));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::AFTER_PLAY_MINION));
...
//                std::make_shared<DamageTask>(EntityType::TARGET, 4, true) }))
//    };
//    cards.emplace("VAN_EX1_609", CardDef(power));
//
//    // ----------------------------------------- SPELL - HUNTER
...
//    cardDef.power.AddPowerTask(
//        std::make_shared<DamageTask>(EntityType::TARGET, 3, true));
//    cardDef.power.AddPowerTask(std::make_shared<FreezeTask>(EntityType::TARGET));
//    cards.emplace(
//        "VAN_CS2_024",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<FreezeTask>(EntityType::ENEMY_MINIONS));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<SummonTask>("VAN_CS2_mirror", 2));
//    cards.emplace(
//        "VAN_CS2_027",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_NUM_MINION_SLOTS, 1 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::CAST_SPELL));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<Aura>(AuraType::HAND,
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::TAKE_DAMAGE));
//    power.GetTrigger()->triggerSource = TriggerSource::HERO;
//    power.GetTrigger()->tasks = ComplexTask::ActivateSecret(TaskList{
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::AFTER_SUMMON));
//    power.GetTrigger()->triggerSource = TriggerSource::FRIENDLY;
//    power.GetTrigger()->tasks = { std::make_shared<AddEnchantmentTask>(
...
//    cardDef.power.AddPowerTask(
//        std::make_shared<DamageTask>(EntityType::ENEMY_MINIONS, 2, true));
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::FRIENDS, 2));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<ControlTask>(EntityType::TARGET));
//    cards.emplace(
//        "VAN_CS1_113",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 },
//                                 { PlayReq::REQ_MINION_TARGET, 0 },
...
//    cardDef.power.AddPowerTask(std::make_shared<GetGameTagTask>(EntityType::TARGET,
//                                                        GameTag::DAMAGE, 0, 1));
//    cardDef.power.AddPowerTask(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::ENEMY_HAND, 1));
//    cardDef.power.AddPowerTask(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<RandomTask>(EntityType::ENEMY_DECK, 2));
//    cardDef.power.AddPowerTask(
//        std::make_shared<CopyTask>(EntityType::STACK, ZoneType::HAND));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::TURN_START));
//    power.GetTrigger()->tasks = {
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<IncludeTask>(EntityType::ENEMY_DECK));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::ALL_MINIONS, 4));
...
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::WEAPON));
//    cards.emplace(
//        "VAN_CS2_233",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_WEAPON_EQUIPPED, 0 } }));
//
...
//    cardDef.power.AddPowerTask(
//        std::make_shared<IncludeAdjacentTask>(EntityType::TARGET));
//    cardDef.power.AddPowerTask(std::make_shared<DamageNumberTask>(EntityType::STACK));
//    cards.emplace("VAN_EX1_126",
//                  CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 },
//                                           { PlayReq::REQ_MINION_TARGET, 0 },
//                                           { PlayReq::REQ_ENEMY_TARGET, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 1));
//    cardDef.power.AddComboTask(std::make_shared<DamageTask>(EntityType::TARGET, 2));
//    cards.emplace(
//        "VAN_EX1_133",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_IF_AVAILABLE, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<ReturnHandTask>(EntityType::TARGET));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddComboTask(std::make_shared<ReturnHandTask>(EntityType::TARGET));
//    cards.emplace(
//        "VAN_NEW1_005",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_MINION_TARGET, 0 },
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<SetGameTagTask>(EntityType::TARGET,
//                                                        GameTag::STEALTH, 1));
//    cards.emplace(
//        "VAN_NEW1_014",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_IF_AVAILABLE, 0 },
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 3));
//    cards.emplace(
//        "VAN_CS2_042",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_IF_AVAILABLE, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::ALL, 3, true));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::ALL, 1));
...
//    cardDef.power.AddPowerTask(std::make_shared<GetGameTagTask>(EntityType::STACK,
//                                                        GameTag::ATK, 0, 1));
//    cardDef.power.AddPowerTask(std::make_shared<GetGameTagTask>(EntityType::STACK,
//                                                        GameTag::ATK, 1, 2));
//    cardDef.power.AddPowerTask(
...
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::STACK));
//    cardDef.power.AddPowerTask(std::make_shared<AddEnchantmentTask>(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::TARGET, 4));
//    cardDef.power.AddPowerTask(std::make_shared<DiscardTask>(1));
//    cards.emplace(
//        "VAN_EX1_308",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_TO_PLAY, 0 } }));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::ALL_MINIONS));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::HERO, 5));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::HERO, 3));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<EnrageEffect>(AuraType::SELF, "EX1_414e"));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<HealTask>(EntityType::TARGET, 3));
//    cards.emplace(
//        "VAN_CS2_117",
//        CardDef(power, PlayReqs{ { PlayReq::REQ_TARGET_IF_AVAILABLE, 0 } }));
//
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<EnrageEffect>(AuraType::WEAPON, "CS2_221e"));
...
//    cardDef.power.AddDeathrattleTask(std::make_shared<ControlTask>(EntityType::STACK));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DestroyTask>(EntityType::ENEMY_WEAPON));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<ManaCrystalTask>(1, false, true));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<DamageTask>(EntityType::ALL, 2));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<AdaptiveCostEffect>([](Playable* playable) {
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<SetGameTagTask>(EntityType::SOURCE,
//                                                        GameTag::POISONOUS, 1));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<EnrageEffect>(AuraType::SELF, "EX1_412e"));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddDeathrattleTask(std::make_shared<SummonOpTask>("VAN_EX1_finkle"));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<IncludeTask>(EntityType::ALL_MINIONS));
//    cardDef.power.AddPowerTask(std::make_shared<FilterStackTask>(
//        SelfCondList{ std::make_shared<SelfCondition>(
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<DamageTask>(EntityType::ENEMY_HERO, 3));
...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddAura(std::make_shared<Aura>(AuraType::HANDS,
...
//    }));
//    cards.emplace("VAN_EX1_620", CardDef(power));
//
//    // --------------------------------------- MINION - NEUTRAL
...
//    cards.emplace("VAN_NEW1_018", CardDef(power));
//
//    // --------------------------------------- MINION - NEUTRAL
...
//        std::make_shared<DamageTask>(EntityType::STACK, 1)
//    };
//    cards.emplace("VAN_NEW1_019", CardDef(power));
//
//    // --------------------------------------- MINION - NEUTRAL
...
//    // - TRIGGER_VISUAL = 1
//    // --------------------------------------------------------
//    cardDef.power.AddTrigger(std::make_shared<Trigger>(TriggerType::AFTER_CAST));
//    power.GetTrigger()->triggerSource = TriggerSource::FRIENDLY;
//    power.GetTrigger()->tasks = { std::make_shared<DamageTask>(
//        EntityType::ALL_MINIONS, 1) };
//    cards.emplace("VAN_NEW1_020", CardDef(power));
//
//    // --------------------------------------- MINION - NEUTRAL
...
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(nullptr);
//    cards.emplace("VAN_NEW1_023", CardDef(power));
//
//    // --------------------------------------- MINION - NEUTRAL
...
//    cardDef.power.AddPowerTask(std::make_shared<RemoveHandTask>(EntityType::HAND));
...
//    cardDef.ClearData();
//    cardDef.power.AddPowerTask(std::make_shared<RandomEntourageTask>());
//    cardDef.power.AddPowerTask(std::make_shared<AddStackToTask>(EntityType::HAND));
