...
void BlackTempleCardsGen::AddDemonHunter(std::map<std::string, CardDef>& cards)
{
    ...
    //  - Set: DEMON_HUNTER_INITIATE, Rarity: Common
    // --------------------------------------------------------
    ...
    //  - Set: DEMON_HUNTER_INITIATE, Rarity: Common
    // --------------------------------------------------------
    // Text: Give your hero +2 Attack this turn. Add 'Second Slice' to your
    // hand.
    // --------------------------------------------------------
    ...
    // ----------------------------------- WEAPON - DEMONHUNTER
    // [BT_271] Flamereaper - COST: 7
    //  - Set: DEMON_HUNTER_INITIATE, Rarity: Epic
    // --------------------------------------------------------
    ...
    //  - Race: DEMON, Faction: HORDE, Set: CORE, Rarity: Free
    // --------------------------------------------------------
    // Text: <b>Battlecry:</b> Look at 3 cards in your deck. Choose one to put
    // on top.
    // --------------------------------------------------------
    // GameTag:
    //  - BATTLECRY = 1
    ...
    //  - Race: DEMON, Set: DEMON_HUNTER_INITIATE, Rarity: Common
    // --------------------------------------------------------
    ...
    //  - Set: DEMON_HUNTER_INITIATE, Rarity: Rare
    // --------------------------------------------------------
    ...
    //  - Race: DRAGON, Set: DEMON_HUNTER_INITIATE, Rarity: Legendary
    // --------------------------------------------------------
    ...
    //  - Race: DEMON, Set: DEMON_HUNTER_INITIATE, Rarity: Rare
    // --------------------------------------------------------
    // Text: <b>Rush</b>. After this attacks and kills a minion, it may attack
    // again.
    // --------------------------------------------------------
    // GameTag:
    //  - RUSH = 1
    ...
    //  - Race: DEMON, Set: DEMON_HUNTER_INITIATE, Rarity: Epic
    // --------------------------------------------------------
    // Text: <b>Taunt</b>
    ...
    // ----------------------------------- WEAPON - DEMONHUNTER
    // [BT_921] Aldrachi Warblades - COST: 3
    //  - Set: CORE, Rarity: Free
    // --------------------------------------------------------
    // Text: <b>Lifesteal</b>
    // --------------------------------------------------------
    ...
    //  - Set: DEMON_HUNTER_INITIATE, Rarity: Legendary
    // --------------------------------------------------------
    // Text: After you play the left-
    ...
    std::map<std::string, CardDef>& cards)
{
    ...
    //  - Race: DEMON, Set: DEMON_HUNTER_INITIATE
    // --------------------------------------------------------
