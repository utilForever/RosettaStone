...
//    // --------------------------------------------------------
//    cardDef.ClearData();
//    cardDef.power.AddEnchant(std::make_unique<Enchant>(Effects::AttackHealthN(2)));
...
//    cardDef.power.AddPowerTask(std::make_shared<AddAuraEffectTask>(Effects::AddCost(2),
//                                                           EntityType::TARGET));
//    cards.emplace(
//        "BT_711",
//        CardDef(
