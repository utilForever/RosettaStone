...
{
    return SelfCondition([cardID](Playable* playable) -> bool {
...
{
    return SelfCondition([race](Playable* playable) -> bool {
...
{
    return SelfCondition([num](Playable* playable) -> bool {
...
SelfCondition SelfCondition::IsTagValue(GameTag tag, int value,
                                        RelaSign relaSign)
{
    return SelfCondition([tag, value, relaSign](Playable* playable) -> bool {
...
{
    return SelfCondition([name, isEqual](Playable* playable) -> bool {
...
{
    return SelfCondition([value, relaSign, index](Playable* playable) -> bool {
...
{
    return SelfCondition([cardType](Playable* playable) -> bool {
        if (const auto eventData = playable->game->currentEventData.get();
            eventData)
        {
...
{
    return SelfCondition([zone](Playable* playable) -> bool {
...
{
    return SelfCondition([relaSign](Playable* playable) -> bool {
