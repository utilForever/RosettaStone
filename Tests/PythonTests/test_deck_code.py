...
def test_decode():
    ...
    info = pyRosetta.DeckCode.decode(
        "AAECAR8IxwOHBMkErgaggAOnggObhQPWmQMLngGoArUDxQj+DJjwAu/xAvWJA+aWA/mWA76YAwA="
    )
    ...
    info2 = pyRosetta.DeckCode.decode(
        "AAECAR8IxwOHBMkErgaggAOnggObhQPWmQMAC54BAqgCArUDAsUIAv4MApjwAgLv8QIC9YkDAuaWAwL5lgMCvpgDAg=="
    )
