...
def test_all_cards():
    ...
    assert len(cards) == pyRosetta.NUM_PLAY_MODE_CARDS
...
def test_hero_card():
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_06").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.DRUID).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_05").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.HUNTER).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_08").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.MAGE).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_04").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.PALADIN).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_09").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.PRIEST).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_03").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.ROGUE).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_02").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.SHAMAN).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_07").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.WARLOCK).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_01").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.WARRIOR).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_10").id
        == pyRosetta.Cards.hero_card(pyRosetta.CardClass.DEMONHUNTER).id
    )
...
def test_default_hero_power():
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_06bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.DRUID).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_05bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.HUNTER).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_08bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.MAGE).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_04bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.PALADIN).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_09bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.PRIEST).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_03bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.ROGUE).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_02bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.SHAMAN).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_07bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.WARLOCK).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_01bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.WARRIOR).id
    )
    assert (
        pyRosetta.Cards.find_card_by_id("HERO_10bp").id
        == pyRosetta.Cards.default_hero_power(pyRosetta.CardClass.DEMONHUNTER).id
    )
