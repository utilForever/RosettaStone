...
TEST(MathNumberIndexTask, Run_Sub)
{
    ...
    game.taskStack.num2 = 5;
    game.taskStack.num3 = 3;
    ...
    TaskStatus result = task.Run();
    EXPECT_EQ(result, TaskStatus::COMPLETE);
    EXPECT_EQ(game.taskStack.num2, 2);
}
...
TEST(MathNumberIndexTask, Run_Mul)
{
    ...
    game.taskStack.num4 = 2;
    game.taskStack.num = 4;
    ...
    TaskStatus result = task.Run();
    EXPECT_EQ(result, TaskStatus::COMPLETE);
    EXPECT_EQ(game.taskStack.num3, 8);
}
...
TEST(MathNumberIndexTask, Run_Div)
{
    ...
    game.taskStack.num1 = 9;
    game.taskStack.num2 = 3;
    ...
    TaskStatus result = task.Run();
    EXPECT_EQ(result, TaskStatus::COMPLETE);
    EXPECT_EQ(game.taskStack.num4, 3);
}