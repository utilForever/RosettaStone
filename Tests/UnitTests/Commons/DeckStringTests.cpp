...
{
    EXPECT_ANY_THROW(DeckString::ParseFromString("AAECAR8I"));
    EXPECT_ANY_THROW(DeckString::ParseFromString("AQECAR8IxwOHBMkErgaggAOnggObhQPWmQMLngGoArUDxQj+DJjwAu/xAvWJA+aWA/mWA76YAwA="));
    EXPECT_ANY_THROW(DeckString::ParseFromString("AAICAR8IxwOHBMkErgaggAOnggObhQPWmQMLngGoArUDxQj+DJjwAu/xAvWJA+aWA/mWA76YAwA="));
    EXPECT_ANY_THROW(DeckString::ParseFromString("AAESAR8IxwOHBMkErgaggAOnggObhQPWmQMLngGoArUDxQj+DJjwAu/xAvWJA+aWA/mWA76YAwA="));
    EXPECT_ANY_THROW(DeckString::ParseFromString("AAECAh8FCMcDhwTJBK4GoIADp4IDm4UD1pkDC54BqAK1A8UI/gyY8ALv8QL1iQPmlgP5lgO+mAMA"));
    EXPECT_ANY_THROW(DeckString::ParseFromString("AAECAQAIxwOHBMkErgaggAOnggObhQPWmQMLngGoArUDxQj+DJjwAu/xAvWJA+aWA/mWA76YAwA="));
	...
	DeckInfo info2 = DeckString::ParseFromString("AAECAR8IxwOHBMkErgaggAOnggObhQPWmQMAC54BAqgCArUDAsUIAv4MApjwAgLv8QIC9YkDAuaWAwL5lgMCvpgDAg==");
