...
namespace Hearthstonepp
{
	...
	enum class PlayReq
	{
		...
		ENOUGH_MANA = 14,
		YOUR_TURN = 15,
		NONSTEALTH_ENEMY_TARGET = 16,
		HERO_TARGET = 17,
		SECRET_CAP = 18,
		SECRET_ZONE_CAP = 18,
		MINION_CAP_IF_TARGET_AVAILABLE = 19,
		MINION_CAP = 20,
		TARGET_ATTACKED_THIS_TURN = 21,
		TARGET_IF_AVAILABLE = 22,
		MINIMUM_ENEMY_MINIONS = 23,
		TARGET_FOR_COMBO = 24,
		NOT_EXHAUSTED_ACTIVATE = 25,
		UNIQUE_SECRET_OR_QUEST = 26,
		UNIQUE_SECRET = 26,
		TARGET_TAUNTER = 27,
		CAN_BE_ATTACKED = 28,
		ACTION_PWR_IS_MASTER_PWR = 29,
		TARGET_MAGNET = 30,
		ATTACK_GREATER_THAN_0 = 31,
		ATTACKER_NOT_FROZEN = 32,
		HERO_OR_MINION_TARGET = 33,
		CAN_BE_TARGETED_BY_SPELLS = 34,
		SUBCARD_IS_PLAYABLE = 35,
		TARGET_FOR_NO_COMBO = 36,
		NOT_MINION_JUST_PLAYED = 37,
		NOT_EXHAUSTED_HERO_POWER = 38,
		CAN_BE_TARGETED_BY_OPPONENTS = 39,
		ATTACKER_CAN_ATTACK = 40,
		TARGET_MIN_ATTACK = 41,
		CAN_BE_TARGETED_BY_HERO_POWERS = 42,
		ENEMY_TARGET_NOT_IMMUNE = 43,
		ENTIRE_ENTOURAGE_NOT_IN_PLAY = 44,
		MINIMUM_TOTAL_MINIONS = 45,
		MUST_TARGET_TAUNTER = 46,
		UNDAMAGED_TARGET = 47,
		CAN_BE_TARGETED_BY_BATTLECRIES = 48,
		STEADY_SHOT = 49,
		MINION_OR_ENEMY_HERO = 50,
		TARGET_IF_AVAILABLE_AND_DRAGON_IN_HAND = 51,
		LEGENDARY_TARGET = 52,
		FRIENDLY_MINION_DIED_THIS_TURN = 53,
		FRIENDLY_MINION_DIED_THIS_GAME = 54,
		ENEMY_WEAPON_EQUIPPED = 55,
		TARGET_IF_AVAILABLE_AND_MINIMUM_FRIENDLY_MINIONS = 56,
		TARGET_WITH_BATTLECRY = 57,
		TARGET_WITH_DEATHRATTLE = 58,
		TARGET_IF_AVAILABLE_AND_MINIMUM_FRIENDLY_SECRETS = 59,
		SECRET_CAP_FOR_NON_SECRET = 60,
		SECRET_ZONE_CAP_FOR_NON_SECRET = 60,
		TARGET_EXACT_COST = 61,
		STEALTHED_TARGET = 62,
		MINION_SLOT_OR_MANA_CRYSTAL_SLOT = 63,
		MAX_QUESTS = 64,
		TARGET_IF_AVAILABE_AND_ELEMENTAL_PLAYED_LAST_TURN = 65,
		TARGET_NOT_VAMPIRE = 66,
		TARGET_NOT_DAMAGEABLE_ONLY_BY_WEAPONS = 67,
		NOT_DISABLED_HERO_POWER = 68,
		MUST_PLAY_OTHER_CARD_FIRST = 69,
		HAND_NOT_FULL = 70,
		DRAG_TO_PLAY = 71,
	};
