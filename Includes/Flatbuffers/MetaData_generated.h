...
#ifndef FLATBUFFERS_GENERATED_METADATA_HEARTHSTONEPP_METADATA_H_
#define FLATBUFFERS_GENERATED_METADATA_HEARTHSTONEPP_METADATA_H_
...
struct PlayRequirementsBuilder {
  ...
  void add_key(int32_t key) {
    fbb_.AddElement<int32_t>(PlayRequirements::VT_KEY, key, 0);
  }
...
inline flatbuffers::Offset<Card> CreateCardDirect(
    ...
    uint32_t maxAllowedInDeck = 0) {
  return Hearthstonepp::MetaData::CreateCard(
      _fbb,
...
inline flatbuffers::Offset<TaskMeta> CreateTaskMetaDirect(
  ...
  return Hearthstonepp::MetaData::CreateTaskMeta(
      _fbb,
      trait,
...
inline flatbuffers::Offset<TaskMetaVector> CreateTaskMetaVectorDirect(
  ...
  return Hearthstonepp::MetaData::CreateTaskMetaVector(
      _fbb,
...
inline flatbuffers::Offset<UserSettingTaskMeta> CreateUserSettingTaskMetaDirect(
  ...
  return Hearthstonepp::MetaData::CreateUserSettingTaskMeta(
      _fbb,
...
inline flatbuffers::Offset<DrawTaskMeta> CreateDrawTaskMetaDirect(
  ...
  return Hearthstonepp::MetaData::CreateDrawTaskMeta(
      _fbb,
      numDraw,
      numExhausted,
      numHearts,
...
inline flatbuffers::Offset<BriefTaskMeta> CreateBriefTaskMetaDirect(
  ...
  return Hearthstonepp::MetaData::CreateBriefTaskMeta(
      _fbb,
      currentUser,
      opponentUser,
      currentMana,
...
inline flatbuffers::Offset<RequireMulliganTaskMeta> CreateRequireMulliganTaskMetaDirect(
  ...
  return Hearthstonepp::MetaData::CreateRequireMulliganTaskMeta(
      _fbb,
      size,
...
inline flatbuffers::Offset<GameEndTaskMeta> CreateGameEndTaskMetaDirect(
  ...
  return Hearthstonepp::MetaData::CreateGameEndTaskMeta(
      _fbb,
...
#endif  // FLATBUFFERS_GENERATED_METADATA_HEARTHSTONEPP_METADATA_H_
