...
#ifndef HEARTHSTONEPP_TASK_SERIALIZER_HPP
...
//! Creates a task meta object for playing card task that selects card from hand.
...
//! Creates a task meta object for playing minion task that selects position where
//! minion will summon.
...
//! Creates a task meta object for playing spell task that selects target type and
...
//! Creates a task meta object for targeting task (e.g. combat).
...
//! Creates a task meta object for packing two player's email.
...
//! Creates a task meta object for packing game status.
...
#endif  // HEARTHSTONEPP_TASK_SERIALIZER_HPP
