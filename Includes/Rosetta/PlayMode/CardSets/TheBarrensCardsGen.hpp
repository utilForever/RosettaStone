...
#ifndef ROSETTASTONE_THE_BARRENS_CARDS_GEN_HPP
#define ROSETTASTONE_THE_BARRENS_CARDS_GEN_HPP
...
{
//!
//! \brief TheBarrensCardsGen class.
//!
//! This structure adds THE_BARRENS cards to the data storage with powers,
//! play requirements and entourages.
//!
class TheBarrensCardsGen
{
 public:
...
#endif  // ROSETTASTONE_THE_BARRENS_CARDS_GEN_HPP