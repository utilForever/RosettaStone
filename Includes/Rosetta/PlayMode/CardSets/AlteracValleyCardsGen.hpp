...
#ifndef ROSETTASTONE_ALTERAC_VALLEY_CARDS_GEN_HPP
#define ROSETTASTONE_ALTERAC_VALLEY_CARDS_GEN_HPP
...
{
//!
//! \brief AlteracValleyCardsGen class.
//!
//! This structure adds ALTERAC_VALLEY cards to the data storage with powers,
//! play requirements and entourages.
//!
class AlteracValleyCardsGen
{
 public:
...
#endif  // ROSETTASTONE_ALTERAC_VALLEY_CARDS_GEN_HPP