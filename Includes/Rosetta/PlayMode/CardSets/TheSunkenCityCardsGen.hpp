...
#ifndef ROSETTASTONE_THE_SUNKEN_CITY_CARDS_GEN_HPP
#define ROSETTASTONE_THE_SUNKEN_CITY_CARDS_GEN_HPP
...
{
//!
//! \brief TheSunkenCityCardsGen class.
//!
//! This structure adds THE_SUNKEN_CITY cards to the data storage with powers,
//! play requirements and entourages.
//!
class TheSunkenCityCardsGen
{
 public:
...
#endif  // ROSETTASTONE_THE_SUNKEN_CITY_CARDS_GEN_HPP