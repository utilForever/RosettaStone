...
#ifndef ROSETTASTONE_PLAYMODE_EXPERT1_CARDS_GEN_HPP
#define ROSETTASTONE_PLAYMODE_EXPERT1_CARDS_GEN_HPP
...
//!
//! This structure adds EXPERT1 cards to the data storage with powers,
...
class Expert1CardsGen
{
 public:
    ...
    //! Adds dream cards that are not collectible to \p cards.
    //! \param cards A list of cards to store the data such as powers,
    //! play requirements and entourages.
    static void AddDreamNonCollect(std::map<std::string, CardDef>& cards);
...
#endif  // ROSETTASTONE_PLAYMODE_EXPERT1_CARDS_GEN_HPP
