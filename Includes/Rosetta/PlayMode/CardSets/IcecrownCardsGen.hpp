...
#ifndef ROSETTASTONE_ICECROWN_CARDS_GEN_HPP
#define ROSETTASTONE_ICECROWN_CARDS_GEN_HPP
...
{
//!
//! \brief IcecrownCardsGen class.
//!
//! This structure adds ICECROWN cards to the data storage with powers,
//! play requirements and entourages.
//!
class IcecrownCardsGen
{
 public:
...
#endif  // ROSETTASTONE_ICECROWN_CARDS_GEN_HPP