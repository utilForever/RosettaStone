...
#ifndef ROSETTASTONE_PLAYMODE_GILNEAS_CARDS_GEN_HPP
#define ROSETTASTONE_PLAYMODE_GILNEAS_CARDS_GEN_HPP
...
{
//!
//! \brief GilneasCardsGen class.
//!
//! This structure adds GILNEAS cards to the data storage with powers,
//! play requirements and entourages.
//!
class GilneasCardsGen
{
 public:
...
#endif  // ROSETTASTONE_PLAYMODE_GILNEAS_CARDS_GEN_HPP
