...
#ifndef ROSETTASTONE_VANILLA_CARDS_GEN_HPP
#define ROSETTASTONE_VANILLA_CARDS_GEN_HPP
...
{
//!
//! \brief VanillaCardsGen class.
//!
//! This structure adds VANILLA cards to the data storage with powers,
//! play requirements and entourages.
//!
class VanillaCardsGen
{
 public:
