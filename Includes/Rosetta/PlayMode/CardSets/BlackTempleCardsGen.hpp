...
#ifndef ROSETTASTONE_PLAYMODE_BLACK_TEMPLE_CARDS_GEN_HPP
#define ROSETTASTONE_PLAYMODE_BLACK_TEMPLE_CARDS_GEN_HPP
...
{
//!
//! \brief BlackTempleCardsGen class.
//!
//! This structure adds BLACK_TEMPLE cards to the data storage with powers,
//! play requirements and entourages.
//!
class BlackTempleCardsGen
{
 public:
...
#endif  // ROSETTASTONE_PLAYMODE_BLACK_TEMPLE_CARDS_GEN_HPP
