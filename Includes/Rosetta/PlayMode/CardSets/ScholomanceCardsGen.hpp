...
#ifndef ROSETTASTONE_PLAYMODE_SCHOLOMANCE_CARDS_GEN_HPP
#define ROSETTASTONE_PLAYMODE_SCHOLOMANCE_CARDS_GEN_HPP
...
{
//!
//! \brief ScholomanceCardsGen class.
//!
//! This structure adds SCHOLOMANCE cards to the data storage with powers,
//! play requirements and entourages.
//!
class ScholomanceCardsGen
{
 public:
    ...
    //! Adds dual-class cards that are not collectible to \p cards.
    //! \param cards A list of cards to store the data such as powers,
    //! play requirements and entourages.
    static void AddDual(std::map<std::string, CardDef>& cards);

    //! Adds dual-class cards that are not collectible to \p cards.
    //! \param cards A list of cards to store the data such as powers,
    //! play requirements and entourages.
    static void AddDualNonCollect(std::map<std::string, CardDef>& cards);
...
#endif  // ROSETTASTONE_PLAYMODE_SCHOLOMANCE_CARDS_GEN_HPP
