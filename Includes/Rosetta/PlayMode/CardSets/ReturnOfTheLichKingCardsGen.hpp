...
#ifndef ROSETTASTONE_RETURN_OF_THE_LICH_KING_CARDS_GEN_HPP
#define ROSETTASTONE_RETURN_OF_THE_LICH_KING_CARDS_GEN_HPP
...
{
//!
//! \brief ReturnOfTheLichKingCardsGen class.
//!
//! This structure adds RETURN_OF_THE_LICH_KING cards to the data storage
//! with powers, play requirements and entourages.
//!
class ReturnOfTheLichKingCardsGen
{
 public:
...
#endif  // ROSETTASTONE_RETURN_OF_THE_LICH_KING_CARDS_GEN_HPP
