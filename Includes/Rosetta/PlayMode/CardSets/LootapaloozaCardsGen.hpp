...
#ifndef ROSETTASTONE_PLAYMODE_LOOTAPALOOZA_CARDS_GEN_HPP
#define ROSETTASTONE_PLAYMODE_LOOTAPALOOZA_CARDS_GEN_HPP
...
{
//!
//! \brief LootapaloozaCardsGen class.
//!
//! This structure adds LOOTAPALOOZA cards to the data storage with powers,
//! play requirements and entourages.
//!
class LootapaloozaCardsGen
{
 public:
...
#endif  // ROSETTASTONE_PLAYMODE_LOOTAPALOOZA_CARDS_GEN_HPP
