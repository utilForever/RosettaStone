...
#ifndef ROSETTASTONE_DARKMOON_FAIRE_CARDS_GEN_HPP
#define ROSETTASTONE_DARKMOON_FAIRE_CARDS_GEN_HPP
...
{
//!
//! \brief DarkmoonFaireCardsGen class.
//!
//! This structure adds DARKMOON_FAIRE cards to the data storage with powers,
//! play requirements and entourages.
//!
class DarkmoonFaireCardsGen
{
 public:
...
#endif  // ROSETTASTONE_DARKMOON_FAIRE_CARDS_GEN_HPP