...
#ifndef ROSETTASTONE_STORMWIND_CARDS_GEN_HPP
#define ROSETTASTONE_STORMWIND_CARDS_GEN_HPP
...
{
//!
//! \brief StormwindCardsGen class.
//!
//! This structure adds STORMWIND cards to the data storage with powers,
//! play requirements and entourages.
//!
class StormwindCardsGen
{
 public:
...
#endif  // ROSETTASTONE_STORMWIND_CARDS_GEN_HPP