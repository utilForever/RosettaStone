...
#ifndef ROSETTASTONE_PLAYMODE_BOOMSDAY_CARDS_GEN_HPP
#define ROSETTASTONE_PLAYMODE_BOOMSDAY_CARDS_GEN_HPP
...
{
//!
//! \brief BoomsdayCardsGen class.
//!
//! This structure adds BOOMSDAY cards to the data storage with powers,
//! play requirements and entourages.
//!
class BoomsdayCardsGen
{
 public:
...
#endif  // ROSETTASTONE_PLAYMODE_BOOMSDAY_CARDS_GEN_HPP
