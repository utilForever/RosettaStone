...
#ifndef ROSETTASTONE_KARA_CARDS_GEN_HPP
#define ROSETTASTONE_KARA_CARDS_GEN_HPP
...
{
//!
//! \brief KaraCardsGen class.
//!
//! This structure adds KARA cards to the data storage with powers,
