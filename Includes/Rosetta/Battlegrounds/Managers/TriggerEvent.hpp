...
#ifndef ROSETTASTONE_BATTLEGROUNDS_TRIGGER_EVENT_HPP
#define ROSETTASTONE_BATTLEGROUNDS_TRIGGER_EVENT_HPP
...
class TriggerEvent
{
 ...
 private:
    ...
    //! \param minion The argument of functor.
    void NotifyHandlers(Minion& minion);

    std::vector<TriggerEventHandler> m_handlers;
    bool m_isNotifying = false;
};
}  // namespace RosettaStone::Battlegrounds

#endif  // ROSETTASTONE_BATTLEGROUNDS_TRIGGER_EVENT_HPP