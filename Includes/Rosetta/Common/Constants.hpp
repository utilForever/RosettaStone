...
constexpr int NUM_PLAY_MODE_CARDS = 14341;

//! The number of Battlegrounds cards.
constexpr int NUM_BATTLEGROUNDS_CARDS = 15855;
...
constexpr int NUM_BATTLEGROUNDS_HEROES = 81;
...
constexpr int NUM_TIER3_MINIONS = 32;
