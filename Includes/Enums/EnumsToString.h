...
namespace Hearthstonepp
{
	...
	const std::map<const CardSet, const std::string> ConverterFromCardSetToString =
	{
		...
		{ CardSet::LOOTAPALOOZA,	"LOOTAPALOOZA" },
		{ CardSet::GILNEAS,			"GILNEAS" }
	};
	...
	const std::map<const GameTag, const std::string> ConverterFromGameTagToString =
	{
		...
		{ GameTag::DATABASE_ID,										"DATABASE_ID" },
		...
		{ GameTag::ZONES_REVEALED,									"ZONES_REVEALED" },
		...
		{ GameTag::TREASURE_DEFINTIONAL_ATTACK,						"TREASURE_DEFINTIONAL_ATTACK" },
		{ GameTag::TREASURE_DEFINTIONAL_COST,						"TREASURE_DEFINTIONAL_COST" },
		{ GameTag::TREASURE_DEFINTIONAL_HEALTH,						"TREASURE_DEFINTIONAL_HEALTH" },
		{ GameTag::ACTS_LIKE_A_SPELL,								"ACTS_LIKE_A_SPELL" },
		{ GameTag::STAMPEDE,										"STAMPEDE" },
		{ GameTag::EMPOWERED_TREASURE,								"EMPOWERED_TREASURE" },
		{ GameTag::ONE_SIDED_GHOSTLY,								"ONE_SIDED_GHOSTLY" },
		{ GameTag::CURRENT_NEGATIVE_SPELLPOWER,						"CURRENT_NEGATIVE_SPELLPOWER" },
		{ GameTag::IS_VAMPIRE,										"IS_VAMPIRE" },
		{ GameTag::CORRUPTED,										"CORRUPTED" },
		{ GameTag::HIDE_HEALTH,										"HIDE_HEALTH" },
		{ GameTag::HIDE_ATTACK,										"HIDE_ATTACK" },
		...
		{ GameTag::LOOT_CARD_1,										"LOOT_CARD_1" },
		{ GameTag::LOOT_CARD_2,										"LOOT_CARD_2" },
		{ GameTag::LOOT_CARD_3,										"LOOT_CARD_3" },
		...
		{ GameTag::DUNGEON_PASSIVE_BUFF,							"DUNGEON_PASSIVE_BUFF" },
		{ GameTag::GHOSTLY,											"GHOSTLY" },
		{ GameTag::DISGUISED_TWIN,									"DISGUISED_TWIN" },
		{ GameTag::SECRET_DEATHRATTLE,								"SECRET_DEATHRATTLE" },
		{ GameTag::RUSH,											"RUSH" },
		{ GameTag::REVEAL_CHOICES,									"REVEAL_CHOICES" },
		{ GameTag::HIDDEN_CHOICE,									"HIDDEN_CHOICE" },
		{ GameTag::ZOMBEAST,										"ZOMBEAST" },
		{ GameTag::HERO_EMOTE_SILENCED,								"HERO_EMOTE_SILENCED" },
		{ GameTag::MINION_IN_HAND_BUFF,								"MINION_IN_HAND_BUFF" },
		{ GameTag::ECHO,											"ECHO" },
		{ GameTag::IGNORE_HIDE_STATS_FOR_BIG_CARD,					"IGNORE_HIDE_STATS_FOR_BIG_CARD" },
		{ GameTag::REAL_TIME_TRANSFORM,								"REAL_TIME_TRANSFORM" },
		{ GameTag::WAIT_FOR_PLAYER_RECONNECT_PERIOD,				"WAIT_FOR_PLAYER_RECONNECT_PERIOD" },
		{ GameTag::PHASED_RESTART,									"PHASED_RESTART" },
		{ GameTag::HEALTH_DISPLAY,									"HEALTH_DISPLAY" },
		{ GameTag::ENABLE_HEALTH_DISPLAY,							"ENABLE_HEALTH_DISPLAY" },
		{ GameTag::VOODOO_LINK,										"VOODOO_LINK" },
		{ GameTag::ATTACKABLE_BY_RUSH,								"ATTACKABLE_BY_RUSH" },
		{ GameTag::SHIFTING_SPELL,									"SHIFTING_SPELL" },
		{ GameTag::USE_ALTERNATE_CARD_TEXT,							"USE_ALTERNATE_CARD_TEXT" },
		{ GameTag::SUPPRESS_DEATH_SOUND,							"SUPPRESS_DEATH_SOUND" },
		{ GameTag::ECHOING_OOZE_SPELL,								"ECHOING_OOZE_SPELL" },
		{ GameTag::COLLECTIONMANAGER_FILTER_MANA_EVEN,				"COLLECTIONMANAGER_FILTER_MANA_EVEN" },
		{ GameTag::COLLECTIONMANAGER_FILTER_MANA_ODD,				"COLLECTIONMANAGER_FILTER_MANA_ODD" },
		{ GameTag::ZOMBEAST_DEBUG_CURRENT_BEAST_DATABASE_ID,		"ZOMBEAST_DEBUG_CURRENT_BEAST_DATABASE_ID" },
		{ GameTag::ZOMBEAST_DEBUG_CURRENT_ITERATION,				"ZOMBEAST_DEBUG_CURRENT_ITERATION" },
		{ GameTag::ZOMBEAST_DEBUG_MAX_ITERATIONS,					"ZOMBEAST_DEBUG_MAX_ITERATIONS" },
		{ GameTag::START_OF_GAME,									"START_OF_GAME" },
		{ GameTag::ENCHANTMENT_INVISIBLE,							"ENCHANTMENT_INVISIBLE" },

		// More or less guessed gametags
		{ GameTag::HEADCRACK_COMBO,									"HEADCRACK_COMBO" },
		{ GameTag::RESTORE_TO_DAMAGE,								"RESTORE_TO_DAMAGE" },
		{ GameTag::CONTROLLER_CHANGED_THIS_TURN,					"CONTROLLER_CHANGED_THIS_TURN" },
		{ GameTag::EXTRA_BATTLECRY,									"EXTRA_BATTLECRY" },
		{ GameTag::NUM_SPELLS_PLAYED_THIS_TURN,						"NUM_SPELLS_PLAYED_THIS_TURN" },
		{ GameTag::NUM_CARDS_TO_DRAW,								"NUM_CARDS_TO_DRAW" },
		{ GameTag::MOAT_LURKER_MINION,								"MOAT_LURKER_MINION" },
		{ GameTag::TAG_LAST_KNOWN_ATK_IN_HAND,						"TAG_LAST_KNOWN_ATK_IN_HAND" },
		{ GameTag::EXTRA_END_TURN_EFFECT,							"EXTRA_END_TURN_EFFECT" },
		{ GameTag::AMOUNT_HERO_HEALED_THIS_TURN,					"AMOUNT_HERO_HEALED_THIS_TURN" },
		{ GameTag::KEEP_ENCHANTMENTS,								"KEEP_ENCHANTMENTS" },
		{ GameTag::NUM_SPELLS_PLAYED_THIS_GAME,						"NUM_SPELLS_PLAYED_THIS_GAME" },
		{ GameTag::NUM_SECRETS_PLAYED_THIS_GAME,					"NUM_SECRETS_PLAYED_THIS_GAME" },
		{ GameTag::NUM_WEAPONS_PLAYED_THIS_GAME,					"NUM_WEAPONS_PLAYED_THIS_GAME" },
		{ GameTag::LAST_CARD_DRAWN,									"LAST_CARD_DRAWN" },
		{ GameTag::LAST_CARD_DISCARDED,								"LAST_CARD_DISCARDED" },
		{ GameTag::NUM_ELEMENTAL_PLAYED_THIS_TURN,					"NUM_ELEMENTAL_PLAYED_THIS_TURN" },
		{ GameTag::NUM_ELEMENTAL_PLAYED_LAST_TURN,					"NUM_ELEMENTAL_PLAYED_LAST_TURN" },
		{ GameTag::NUM_MURLOCS_PLAYED_THIS_GAME,					"NUM_MURLOCS_PLAYED_THIS_GAME" },
		{ GameTag::TAG_LAST_KNOWN_POSITION_ON_BOARD,				"TAG_LAST_KNOWN_POSITION_ON_BOARD" },
	};
	...
	const std::map<const PlayReq, const std::string> ConverterFromPlayReqToString =
	{
		...
		{ PlayReq::REQ_TARGET_IF_AVAILABLE_AND_NO_3_COST_CARD_IN_DECK,		"REQ_TARGET_IF_AVAILABLE_AND_NO_3_COST_CARD_IN_DECK" },
		{ PlayReq::REQ_CAN_BE_TARGETED_BY_COMBOS,							"REQ_CAN_BE_TARGETED_BY_COMBOS" },
		{ PlayReq::REQ_CANNOT_PLAY_THIS,									"REQ_CANNOT_PLAY_THIS" },
		{ PlayReq::REQ_FRIENDLY_MINIONS_OF_RACE_DIED_THIS_GAME,				"REQ_FRIENDLY_MINIONS_OF_RACE_DIED_THIS_GAME" },
